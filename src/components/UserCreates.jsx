...
const UserCreates = () => {
  return (
    <>
      <div className="bg-pink-100 p-10 h-screen text-center max-w-screen-lg mx-auto ">
        <h1 className="text-4xl  my-3">　User Create Stage Select　</h1>
          ...
          <div className="p-3 w-1/3 md:w-1/3 lg:w-1/3">
            <div className="flex p-5 bg-white items-start border-2 border-black ">
              ...
              <div className="flex flex-col justify-start items-start p-2 " style={{ width: '100px' }}>
                ...
                <Link to={RoutePath.sample3.path}>
                  <button className="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-700 focus:outline-none">
                    Play
                  </button>
                </Link>
              </div>
              ...
              <div>
                <Link to={RoutePath.sample3.path}>
                  <img src={`${process.env.PUBLIC_URL}/image2.png`} alt="Stage" />
                </Link> 
              </div>
            </div>
          </div>
